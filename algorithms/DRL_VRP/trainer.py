...
from algorithms.DRL_VRP.model import DRL4TSP, Encoder
...
def train_tsp(args):
    ...
    from algorithms.DRL_VRP.tasks import tsp
    from algorithms.DRL_VRP.tasks.tsp import TSPDataset
...
def train_vrp(args):
    ...
    from algorithms.DRL_VRP.tasks import vrp
    from algorithms.DRL_VRP.tasks.vrp import VehicleRoutingDataset

    # Determines the maximum amount of load for a vehicle based on num nodes
    LOAD_DICT = {10: 20, 20: 30, 30: 34, 40: 37, 50: 40, 60: 43, 70: 45, 80: 47, 90: 49, 100: 50,
                 150: 60, 200: 65, 250: 70}
    MAX_DEMAND = 9
    STATIC_SIZE = 2  # (x, y)
